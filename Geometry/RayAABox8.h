...
f_inline Vec8 RayAABox8(const Vec3 &inOrigin, const Vec3 &inInvDirection, const UVec4 &inIsParallel, const Vec8 &inBoundsMinX, const Vec8 &inBoundsMinY, const Vec8 &inBoundsMinZ, const Vec8 &inBoundsMaxX, const Vec8 &inBoundsMaxY, const Vec8 &inBoundsMaxZ)
{
	// Constants
	...
	// Parallel
	UVec8 parallelx = UVec8::sSplatX(inIsParallel);
	UVec8 parallely = UVec8::sSplatY(inIsParallel);
	UVec8 parallelz = UVec8::sSplatZ(inIsParallel);

	// Inverse direction
	Vec8 invdirx = Vec8::sSplatX(Vec4(inInvDirection));
	Vec8 invdiry = Vec8::sSplatY(Vec4(inInvDirection));
	Vec8 invdirz = Vec8::sSplatZ(Vec4(inInvDirection));
