...
public:
	...
	public:
		...
		// Axis (dimension) and value along which the triangles were split
		uint				mSplitDimension;
		float				mSplitValue;
...
private:
	Node *					BuildInternal(TriangleSplitter::Range &inTriangles, ProgressIndicator &inProgress);
